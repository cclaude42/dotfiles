# Generated by Powerlevel10k configuration wizard on 2023-07-03 at 17:19 CEST.
...
() {
  ...
  #
  # Uncomment this if you want kube info to be hidden by default :
  ...
  # 
  # Uncomment this if you want aws info to be hidden by default :
